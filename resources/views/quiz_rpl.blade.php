...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="{{ asset('css/quiz_rpl.css') }}">
</head>
<body>
    ...
    <div class="quiz-container mx-auto col-md-8">
      ...
      <form action="{{ route('quiz.saveResult', $quiz->id) }}" method="POST" id="quiz-form" onsubmit="return goToLeaderboard(event)">
        ...
        <div id="quiz-section">
          ...
          <button id="next-btn" class="btn btn-danger mt-3" type="button" onclick="nextQuestion()" style="display:none;">
            ➡️ Soal Selanjutnya
          </button>
        </div>
  ...
  <!-- Custom JS -->
  <script src="{{ asset('js/quiz_rpl.js') }}"></script>
</body>
</html>
